...
impl Client {
    ...
    pub(crate) async fn send_message_impl(
        ...
        let stanza_to_send: warp_core_binary::Node = if peer && !to.is_group() {
            ...
            warp_core::send::prepare_peer_stanza(
            ...
            let force_skdm = {
                use warp_core::libsignal::protocol::SenderKeyStore;
            ...
            let mut stores = warp_core::send::SignalStores {
            ...
            .await
            {
                ...
                Err(e) => {
                        ...
                        e.downcast_ref::<SignalProtocolError>()
                    {
                        ...
                        let mut stores_retry = warp_core::send::SignalStores {
